...
String tempTime = "2025-09-05 00:00:00";
...
<div class="signpage"  ; style="margin:150px 10px 10px 10px; width:100%";>
<% if(!message.equals("")){ %>
<div class="alert alert-danger" ;; style="margin:100px 80px 10px 270px; width:67%" ><p><%= message %></p></div>
<% } %>
	<% if(isSearchBoxNeed){ %>
	...
	<% }else{ %>
		<div class="rs_box" style="overflow:auto;">
			<form class="ticket_selecting_form" method="post" name="frm_deslist" ; style="margin:100px 10px 10px 200px; width:75%">
				<h2 class="title"> Train Name: Karnataka Expresss <br>Station From: Bangalore </h2>
				...
				<div class="text-center">
					<div class="rs_btn_group">
						<button style="color: black; background-color: #e0bc00;" class="btn btn-success pull-left" name="save_all" type="submit">Save All</button>
						<button style="color: black; background-color: #e0bc00;"  id="btn_add_new_item" class="btn btn-info pull-left" name="search" type="button">Add New Item</button>
					</div>
				</div>
			</form>
