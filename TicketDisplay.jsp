...
<form class="ticket_selecting_form" action="<%= Helper.baseUrl %>FindTicket.jsp" style="margin:200px 10px 10px 200px; width:75%">
	<h2 class="title">  <span>Train Route Showing For :: </span> <%= stationFromObj.name %> to  <%= stationToObj.name %> <br>
	<span> Journey Date ::</span> <%= journey_date %> </h2>
	<table class="table rs_shadow">
		...
		<tr>
			...
			<td>
				<a href="javascript:;" class="buttonTrain rs_search_ticket" data-date="<%= journey_date %>" data-destination="<%= tempTrain.get("destination_id") %>">Search Ticket</a>
			</td>
		</tr>
		<% } %>
	</table>
