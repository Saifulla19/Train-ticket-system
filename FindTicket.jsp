...
<%
	...
	if(totalSeat != null && date != null && destination != null && actionType.equals("search")){
		...
		<div class="ticket_info">
			<h2 style="background:#e0bc00">Ticket Details</h2>
			<table class="table">
				<tr>
					<td>
						<ul>
					...
					<td>
						<ul>
							<li><strong>Fare</strong> <span><%= Double.toString(totalamount) + " INR " %></span></li>
							<li><strong>Bank Charge</strong> <span><%= bankCharge + " INR "%></span></li>
							<li><strong>Total Amount</strong> <span><%= (totalamount+bankCharge)+ " INR " %></span></li>
						</ul>
					</td>
				</tr>
			</table>
			<div class="rs_btn_sections">
				<a href="" class="buttonTrain btn_confirm_ticket" data-destination="<%= destination %>" data-seat="<%= totalSeat %>" data-date="<%= date %>">Confirm/Book Now</a>
			</div>
		</div>
		<% 
		} 
		...
		%>
		<div class="ticket_info h22" >
			<h2 style="background:#e0bc00">Congratulation! Your ticket has been booked.</h2>
