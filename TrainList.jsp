...
<br>
<div class="box successfully_purschase_ticket" style="margin:150px 10px 10px 200px; width:75%;">
	<h2 class="box_title">All Train List <span>
	<div class="text-right">
	<a class="btn buttonTrain" href="Add.jsp">Create Train</a>
</div></span></h2>
