...
<html lang="en">
  ...
  <body>
  	<div class="header">
  		<div class="container">
  			<div class="header_content "; style="font-size:23px">
  			    <img class="logo"  src="https://cdn0.iconfinder.com/data/icons/phosphor-duotone-vol-3/256/train-simple-duotone-1024.png">
  			    Rolling on rails
  			</div>
  			<div class="main_nav">
